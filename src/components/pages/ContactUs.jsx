            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-10 items-center p-2 sm:p-5">
                ...
                <div className="h-full flex flex-col justify-evenly transition-all">
                    <div>
                        ...
                        <h2 className={`text-3xl md:text-4xl font-bold ${theme === 'light' ? 'text-[#383185]' : 'text-white'} mb-4 z-99`}>CONTACT US</h2>
                    </div>
                    ...
                    <form className="space-y-4 mt-10" onSubmit={handleSubmit(onSubmit)}>
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full border ${theme === 'dark' ? 'bg-[#1B273B] text-white' : 'bg-white/90 text-gray-800'} border-gray-400 focus:outline-none focus:ring-1 focus:ring-[#383185] rounded px-3 py-3`}
                            />
                        </div>
