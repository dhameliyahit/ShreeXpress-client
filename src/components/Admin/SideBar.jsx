...
import { Box, List, ListItemButton, ListItemIcon, ListItemText, Tooltip, IconButton } from '@mui/material';
import { FaBars, FaTachometerAlt, FaShippingFast, FaUsers, FaChartBar, FaPlus } from 'react-icons/fa';
    ...
    return (
        ...
        >
            ...
            <List sx={{ px: 1, flex: 1 }}>
                ...
                {/* Logout item */}
                <Tooltip title={!open ? 'Logout' : ''} placement="end" arrow>
                    <ListItemButton
