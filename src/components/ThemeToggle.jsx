...
export default function ThemeToggle() {
    ...
    return (
        <div className="flex items-center">
            <div onClick={toggleTheme} className={`w-14 h-8 flex items-center bg-gray-300 dark:bg-[#292929] rounded-full p-1 cursor-pointer transition-colors duration-300`} >
