        ...
        <div className="pr-4 first:text-[#E31E25] hidden md:flex">
          {navigationLinks.map((link, index) => (
            <Link
              key={index}
              to={link.path}
              className={`mx-2 uppercase text-[13px] pb-[2px] transition duration-200 border-b-2 border-transparent
                hover:border-[#E31E25] hover:text-[#E31E25]
                focus:text-[#E31E25] focus:border-[#E31E25]
                ${index === 0 ? "text-[#E31E25]" : "text-black"}`}
            >
              {link.name}
            </Link>
